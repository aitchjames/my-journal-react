        ...
        switch (action.type) {
            ...
            case "emailUniqueResults":
                if (action.value) {
                    draft.username.hasErrors = true
                    draft.username.isUnique = false
                    draft.username.message = "That email is already being used"
                } else {
        ...
        if (state.submitCount) {
            ...
            async function fetchResults() {
                try {
                    ...
                    appDispatch({type: "flashMessage", value: "Welcome to My Journal"})
                } catch (error) {
                    console.log("There was a problem or request was cancelled")
                }
            }
        ...
        <Page title="Welcome" wide={true}>
            <div className="row align-items-center">
                <div className="col-lg-7 py-3 py-md-5">
                    ...
                    <p className="lead text-muted">Are you sick of short tweets and impersonal &ldquo;shared&rdquo; posts that
                ...
                <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <input onChange={event => dispatch({type: "usernameImmediately", value: event.target.value})} id="username-register" name="username" className="form-control" type="text"
                        ...
                        <div className="form-group">
                            ...
                            <input onChange={event => dispatch({type: "emailImmediately", value: event.target.value})} id="email-register" name="email" className="form-control" type="text"
                        ...
                        <div className="form-group">
                            ...
                            <input onChange={event => dispatch({type: "passwordImmediately", value: event.target.value})} id="password-register" name="password" className="form-control" type="password"
